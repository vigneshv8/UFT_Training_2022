/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘API_Search_Create.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>Denver</DepartureCity><ArrivalCity>London</ArrivalCity><FlightDate>2022-12-30T00:00:00+00:00</FlightDate></GetFlights></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>First</Class><CustomerName>John H</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity5.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity5.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>1</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            bind_dir4 = new BindDirection(_flow.StServiceCallActivity5,binding_getter4,binding_setter4,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity6.InDirections.Add(bind_dir4);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><CreateFlightOrderResponse xmlns=""HP.SOAQ.SampleApp""><CreateFlightOrderResult><OrderNumber>87</OrderNumber></CreateFlightOrderResult></CreateFlightOrderResponse></Body></Envelope>");
